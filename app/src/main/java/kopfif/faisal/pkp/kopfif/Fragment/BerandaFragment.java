...
public class BerandaFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        Picasso.with(getContext())
                .load("http://www.arabnewtech.com/wp-content/uploads/avatar-1.png")
        ...
        menu1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Snackbar.make(view, "menu1 clicked", Snackbar.LENGTH_LONG).show();
            }
        });
        menu2.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Snackbar.make(view, "menu2 clicked", Snackbar.LENGTH_LONG).show();
            }
        });
        menu3.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Snackbar.make(view, "menu3 clicked", Snackbar.LENGTH_LONG).show();
            }
        });
        ...
        name.setText("Name");
//        name.setText(util.sessionUserGet("name"));
        // makeSlider(view);
